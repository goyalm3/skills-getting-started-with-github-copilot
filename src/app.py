...
activities = {
    ...
    "Music Band": {
        ...
        "max_participants": 25,
        "participants": ["ryan@mergington.edu", "emily@mergington.edu", "chris@mergington.edu"]
    },
    "Debate Club": {
    ...
    "Robotics Club": {
        ...
        "max_participants": 12,
        "participants": ["alex@mergington.edu", "rachel@mergington.edu", "tyler@mergington.edu"]
    },
    "Cricket Team": {
        "description": "Learn cricket skills and participate in matches",
